...
class MessagePage extends StatelessWidget {
  ...
  static const List<_Message> _messages = [
    _Message(name: 'Keith',   text: 'Hey! How are you?',       time: '9:30 AM',  unread: 3),
    _Message(name: 'Ange',     text: 'See you tomorrow!',        time: '8:15 AM',  unread: 0),
    _Message(name: 'Faith', text: 'Did you see the update?',  time: 'Yesterday', unread: 1),
    _Message(name: 'Abby',   text: 'Flutter is amazing 🚀',   time: 'Yesterday', unread: 0),
    _Message(name: 'Lori',     text: 'Let\'s meet at 3PM',       time: 'Monday',   unread: 2),
  ];
...
class _ChatDetailPage extends StatelessWidget {
  ...
  const _ChatDetailPage({required this.message});
